...
import ctypes
from raw import *
import handlers_glumpy as glumpy
import handlers_glut   as glut
if 'pyglet' in globals().keys():
    import handlers_pyglet as pyglet
...
class Bar(object):
    ...
    def __del__(self):
        check_error(TwDeleteBar(self._bar))
    ...
    def add_var(self, name, value=None, vtype=None, readonly=False,
        ...
        _typemap = {ctypes.c_bool:      TW_TYPE_BOOL8,
                    ...
                    ctypes.c_char_p:    TW_TYPE_CDSTRING}
